...
var pathProjectRoot = "../../../";
var projectRoot = "./";
var submoduleRoot = '../../submodules/fenix-ui-chart-creator/';
...
require([
	...
	"filterPaths",
	"chartPaths"
], function (Compiler, Common, Filter, ChartCreator ) {
	...
	Compiler.resolve([commonConfig, filterConfig, chartConfig],
		{
