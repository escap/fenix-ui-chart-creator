...
define([
  ...
  //'text!http://ec.europa.eu/eurostat/SDMX/diss-web/rest/data/cdh_e_fos/..PC.FOS1./',
  //  'text!http://ec.europa.eu/eurostat/SDMX/diss-web/rest/data/cdh_e_fos/..PC.FOS1./?startperiod=2005&endPeriod=2011',
   ...
   'text!test/models/XML.xml',
	...
	//'text!https://sdw-wsrest.ecb.europa.eu/service/data/EXR/.USD.EUR.SP00.A',
	//'text!https://sdw-wsrest.ecb.europa.eu/service/datastructure/ECB/ECB_EXR1/latest',
	
    'test/models/filter-interaction'

], function (log, $, _, ChartCreator, Filter, FenixTool, SDMXData,SDMXDSD, FilterModel) {
...
var Model;
    ...
    function Test() {
		...
		Model=this.fenixTool.sdmxToFenix(SDMXData,SDMXDSD);
